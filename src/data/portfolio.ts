...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    infoCards: {
      ...
      industry: {
        label: "Industry",
        value: "Logistics & Mfg",
        subtext: "Supply Chain, Aviation, Automotive",
      },
      location: {
        label: "Location",
        value: "Central Europe",
        subtext: "Frankfurt / Zurich (Open to Global Remote)",
      },
    },
    location: "Frankfurt, Germany / Zurich, Switzerland (Open to Global Remote)",
    currentRole: "Lead SAP Fiori & BTP Solutions Developer",
    currentCompany: "Enterprise Global Consulting",
    ...
    contactEmail: "alexandre.sterling.sap@enterprise-portfolio.dev",
    socials: {
      linkedin: "https://linkedin.com/in/sap-fiori-expert",
  ...
  experience: [
    {
      id: "exp-1",
      company: "AeroTech Global Logistics",
      companyUrl: "https://example.com",
      role: "Lead SAP Fiori & BTP Solutions Architect",
      location: "Frankfurt, Germany",
      workMode: "Hybrid",
      startDate: "Jan 2022",
      endDate: "Present",
      isCurrent: true,
      businessDomain: "Aviation Logistics & Global Air Freight",
      summary:
    ...
    },
    {
      ...
      companyUrl: "https://example.com",
      role: "Senior SAPUI5 & Fiori Developer",
      location: "Zurich, Switzerland",
      workMode: "Hybrid",
      startDate: "Mar 2019",
      endDate: "Dec 2021",
      isCurrent: false,
      businessDomain: "High-Precision Industrial Manufacturing & QM",
      summary:
    ...
    },
    {
      ...
      companyUrl: "https://example.com",
      role: "SAP Technical Consultant (Fiori & ABAP)",
      location: "Munich, Germany",
      workMode: "On-site",
      startDate: "Jul 2017",
      endDate: "Feb 2019",
      isCurrent: false,
      businessDomain: "Automotive Supply Chain & Direct Procurement",
      summary:
        "Contributed to large-scale S/4HANA migration programs for European automotive and chemical clients, focusing on Fiori Launchpad setup and custom apps.",
      responsibilities: [
        "Implemented standard and extended SAP Fiori transactional apps (Approve Purchase Orders, Manage Sales Orders, Track Invoices).",
        "Configured SAP Fiori Launchpad catalogs, groups, PFCG roles, and target mappings for 2,500+ corporate users.",
        "Developed custom ABAP reports, user exits, BAPIs, and SEGW OData services supporting procurement operations.",
        "Performed unit testing, defect resolution, and performance profiling using SAP Gateway Traces and UI5 Diagnostics.",
      ],
      keyAchievements: [
        "Successfully delivered 12 customized procurement Fiori apps on time and under budget for a Tier-1 German automotive supplier.",
        "Refactored inefficient legacy SQL queries across 14 Gateway services, producing a 55% average reduction in server response latency.",
      ],
      technologies: ["SAP Fiori", "SAPUI5", "ABAP OO", "SAP Gateway (SEGW)", "SAP ERP ECC 6.0", "SAP S/4HANA 1709", "HTML5/CSS3"],
    },
  ],
